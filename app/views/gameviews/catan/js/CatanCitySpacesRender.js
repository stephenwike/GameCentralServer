...
function SetCitySpaces(cities)
{
    ...
    for(var i = 0; i < cityKeys.length; i++){
        ...
        img.id = cityKeys[i];
        img.src = "views/gameviews/catan/images/" + cities[cityKeys[i]].IsSettledBy + ".png";
...
{
    var loc = document.getElementById(id).src = "views/gameviews/catan/images/p1settlement.png";
}